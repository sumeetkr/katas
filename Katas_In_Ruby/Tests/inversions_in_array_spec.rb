...
describe "inversions_in_array" do
...
#  Your task is to compute the number of inversions in the file given, where the ith row of the
#file indicates the ith entry of an array.
#
...
#or your own devising. Then post your best test cases to the discussion forums to help your fellow students!]
#
  it "should read file " do

  end

  it "should populate array with content of file" do

  end

  it "should be able to sort an integer array" do

  end

  it "should be able to merge two sorted arrays" do
