...
//			currentNode = node;
	...
	//	If you need to find the lowest common ancestor without parent pointers, 
	...
	//         /  \
	//         7   4
	//If you are not so sure about the definition of lowest common ancestor (LCA), 
	//please refer to my previous post: Lowest Common Ancestor of a Binary Search Tree (BST) 
	//or the definition of LCA here. Using the tree above as an example, the LCA of nodes 5 
